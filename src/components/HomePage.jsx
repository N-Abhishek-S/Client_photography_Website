...
const HomePage = () => {
  ...
  const portfolioCategories = [
    ...
    },
    {
      ...
      thumbnail:
        "https://images.unsplash.com/photo-1492684223066-dd23140edf6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      images: [
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // PORTFOLIO
      const portfolioEls = portfolioGridRef.current
        ? Array.from(
            portfolioGridRef.current.querySelectorAll(".portfolio-item")
          )
        : [];
      ...
      >
        ...
        <div className="relative z-20 text-center px-4 sm:px-6 max-w-6xl mx-auto">
          ...
          <p className="text-base md:text-lg lg:text-xl mb-8 md:mb-12 max-w-2xl mx-auto text-gray-300 leading-relaxed px-4">
            Capturing moments that tell your story. Professional photography and
