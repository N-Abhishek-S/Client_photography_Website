...
function Footer() {
  ...
  const services = ['Photography', 'Videography', 'Editing', 'Consultation', 'Courses', 'PSD Files'];
  const contactInfo = [
    { icon: '✉️', text: 'info@gurustudio.com' },
    { icon: '📞', text: '+1 (555) 123-4567' },
    { icon: '📍', text: '123 Studio Street, Creative City' }
  ];
  ...
  return (
    <div>
      <footer ref={footerRef} className="bg-gray-900 relative overflow-hidden">
            ...
            <div className="xl:col-span-2">
              <div ref={logoRef} className="mb-6">
                ...
                <p className="text-gray-400 text-lg mb-6 max-w-md">
                  Creating timeless visual stories through professional photography 
                  and cinematography. Let us capture your moments with artistic excellence.
                </p>
                ...
                <div className="bg-gray-800/50 rounded-2xl p-6 backdrop-blur-sm border border-gray-700">
                  ...
                  <div className="flex space-x-2">
                    ...
                    />
                    <button className="bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-4 py-2 rounded-lg font-semibold hover:shadow-lg hover:shadow-yellow-400/25 transition-all duration-300 transform hover:scale-105">
                      Join
                    </button>
                  </div>
                </div>
            ...
            <div ref={el => columnsRef.current[2] = el}>
              ...
              <ul className="space-y-4">
                {contactInfo.map((item, index) => (
                  <li key={index} className="flex items-start space-x-3 text-gray-400 hover:text-white transition-colors duration-300">
          ...
          <div ref={bottomRef} className="border-t border-gray-800 pt-8">
            <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
              <div className="text-gray-400 text-center lg:text-left">
                <p>&copy; 2024 Guru Photo Film Official. All rights reserved.</p>
              </div>
              ...
              <div className="flex flex-wrap justify-center lg:justify-end space-x-6 text-sm text-gray-500">
                ...
                <a href="#" className="hover:text-yellow-400 transition-colors duration-300">Sitemap</a>
              </div>
            </div>
        ...
        <div className="absolute bottom-20 left-10 w-6 h-6 bg-orange-500 rounded-full opacity-30 animate-pulse" style={{animationDelay: '1s'}}></div>
