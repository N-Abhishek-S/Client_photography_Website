...
import { getMainServices } from "../appwrite"; // Import your Appwrite function
...
const Services = () => {
  ...
  // Fetch services using the same function as HomePage
  const fetchServices = async () => {
    try {
      setLoading(true);
      console.log("Fetching services from Appwrite...");
  ...
  // Get image URL - same function as HomePage
  const getImageUrl = (item) => {
    ...
    if (imageId) {
      // Construct the URL using environment variables (same as HomePage)
      const endpoint =
    ...
    if (
      ...
      title.toLowerCase().includes("videography")
    ) {
  ...
  const processSteps = [
    {
      ...
      title: "Consultation",
      description:
        "We discuss your vision, requirements, and create a customized plan for your project.",
      icon: "💬",
    },
    {
      step: "02",
      title: "Planning",
      description:
        "Detailed planning including locations, timing, equipment, and creative direction.",
      icon: "📋",
    },
    {
      step: "03",
      title: "Production",
      description:
        "Professional execution of the shoot with attention to detail and creative excellence.",
      icon: "🎯",
    },
    {
      step: "04",
      title: "Delivery",
      description:
        "Careful editing and delivery of final products that exceed your expectations.",
      icon: "🎁",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white pt-20">
      ...
      <section
        ref={heroRef}
        className="py-20 bg-linear-to-br from-gray-900 to-black"
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            capture your most important moments with creativity, technical
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-xl max-w-2xl mx-auto">
              Comprehensive photography and videography services for every
              occasion and need
            </p>
          </div>
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-4 right-4 bg-black/80 text-white px-3 py-1 rounded-full font-semibold">
          From ${service.startingPrice || service.price || 0}
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="flex space-x-3">
          <NavLink 
            to={`/booknow?service=${encodeURIComponent(service.title || service.serviceName || 'Service')}`}
            className="flex-1"
          >
      ...
      <section ref={processRef} className="py-20 bg-gray-800">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-xl max-w-2xl mx-auto">
              A seamless experience from concept to delivery, ensuring your
                ...
                {[
                  {
                    ...
                    description:
                      "Over 8 years of experience in professional photography and videography",
                  },
                  {
                    title: "State-of-the-Art Equipment",
                    description:
                      "Latest camera gear and editing technology for superior results",
                  },
                  {
                    title: "Creative Vision",
                    description:
                      "Unique artistic perspective that sets your content apart",
                  },
                  {
                    title: "Client-Focused Approach",
                    description:
                      "Personalized service tailored to your specific needs and vision",
                  },
                ].map((item, index) => (
      ...
      <section
        ref={ctaRef}
        className="py-20 bg-linear-to-r from-yellow-400 to-orange-500 text-black"
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto">
            Let's work together to capture your unique story through our lens.
